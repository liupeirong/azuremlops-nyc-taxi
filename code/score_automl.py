...
input_sample = pd.DataFrame(data=[{'vendorID': 2.0, 'passengerCount': 1.0, 'tripDistance': 0.43, 'pickupLongitude': -73.9254608154, 'pickupLatitude': 40.8323936462, 'dropoffLongitude': -73.9238586426, 'dropoffLatitude': 40.8364105225, 'totalAmount': 4.8, 'month_num': 1.0, 'day_of_month': 30.0, 'day_of_week': 4.0, 'hour_of_day': 21.0}])
